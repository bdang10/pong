...
pygame.display.set_caption("Bing Pong")

# Global Variables
bg_color = (38, 35, 53)
accent_color = (194, 51, 183)
game_font = pygame.font.Font("font/runescape_uf.ttf", 32)
timer_sound = pygame.mixer.Sound("sound/beep.mp3")
pong_sound = pygame.mixer.Sound("sound/pong.ogg")
score_sound = pygame.mixer.Sound("sound/score.mp3")
arena_line = pygame.Rect(screen_width/2 - 2, 0, 4, screen_height)
...
while True:
	...
	pygame.draw.rect(screen, accent_color, arena_line)
